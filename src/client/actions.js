...
export const TASK_UPDATE__INTERACTIONS = 'TASK_UPDATE__INTERACTIONS'

export const INTERACTIONS__PAGE_CHANGE = 'INTERACTIONS__PAGE_CHANGE'
export const INTERACTIONS__FILTERS_CHANGE = 'INTERACTIONS__FILTERS_CHANGE'
